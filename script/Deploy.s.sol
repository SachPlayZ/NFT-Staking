 ...
 *      forge script script/Deploy.s.sol:Deploy --rpc-url $ZKSYNC_SEPOLIA_RPC --broadcast --verify
 */
contract Deploy is Script {
    function run() external {
        ...
        // Treasury address - can be set to deployer or separate address
 ...
 *      forge script script/Deploy.s.sol:DemoTransactions --rpc-url $ZKSYNC_SEPOLIA_RPC --broadcast
 */
 ...
 *      forge script script/Deploy.s.sol:UnstakeAfterLock --rpc-url $ZKSYNC_SEPOLIA_RPC --broadcast
 */
